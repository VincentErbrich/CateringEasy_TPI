                ...
                try
                {
                    if (readerMenu.HasRows)
                    {
                        while (readerMenu.Read())
                        {
                            ...
                            tlpMenuList.Controls.Add(new Label { Text = readerMenu.GetValue(1).ToString(), Height = 38, AutoSize = false, Font = new Font("Segoe UI Semibold", 12F, FontStyle.Regular, GraphicsUnit.Point) }, 0, tlpMenuList.RowCount);
